...
Action page, plus graduating students from the Term page.

**Usage:**
1. Open the game, log in, and go to the relevant page (Action page for hiring/tenure/passing, Term page for graduating).
